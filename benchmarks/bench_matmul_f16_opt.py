"""Best-performing matmul: transposed tileA, f16 inputs, 4x4 register tile, fully unrolled."""
...
def main():
    ...
    for M in [2048,4096]:
        ...
        A_b=pack_f16_to_u32(A)
        B_b=pack_f16_to_u32(B)
        ctx=setup(device,M,M,M,A_b,B_b)
