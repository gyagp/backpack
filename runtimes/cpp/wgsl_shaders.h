#pragma once
/**
 * wgsl_shaders.h — Embedded WGSL compute kernels (auto-generated).
 *
 * Generated from build/qwen3-1.7B/kernels/*.wgsl
 * Do not edit manually — regenerate with: python gen_shaders.py
 */
...
static const char* WGSL_ADD_RMS_NORM = R"(
enable subgroups;
...
static const char* WGSL_Q8_MATMUL = R"(
...
static const char* WGSL_Q8_MATMUL_ADD = R"(
...
static const char* WGSL_FUSED_QKNORM_ROPE = R"(
enable subgroups;
...
static const char* WGSL_GQA_CHUNKED_PASS1 = R"(
...
static const char* WGSL_GQA_CHUNKED_PASS2 = R"(
...
static const char* WGSL_SILU_MUL_FUSED = R"(
// Auto-generated by Triton WebGPU Backend
...
static const char* WGSL_FP16_GEMM = R"(
...
// Wide FP16 GEMM: TILE_N=32 for LM head (4x fewer workgroups)
// Each warp handles 4 adjacent output columns via loop unrolling.
static const char* WGSL_FP16_GEMM_WIDE = R"(
enable subgroups;
...
// ─── GPU Argmax ──────────────────────────────────────────────────────────────
// Two-pass reduce: pass1 finds max per workgroup, pass2 reduces across groups.
// For simplicity, we use a single pass with atomics.
// Each thread handles N/256 elements, then workgroup reduces via subgroup ops.

static const char* WGSL_ARGMAX = R"(
enable subgroups;
...
// ─── Optimized Q8 Matmul: 16 elements/lane ───────────────────────────────────
// Processes 16 elements per lane per iteration (vs 8 in baseline).
// 32 lanes × 16 = 512 elements per stride. Fewer iterations, better ILP.
// K must be divisible by 512. Falls back to baseline for smaller K.
