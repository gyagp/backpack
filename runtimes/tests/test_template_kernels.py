...
Usage:
    python -m pytest runtimes/tests/test_template_kernels.py -v
    python -m pytest runtimes/tests/test_template_kernels.py -k "test_binary" -v
    python -m pytest runtimes/tests/test_template_kernels.py -k "f16" -v
"""
import os, sys, math
import numpy as np
import pytest
...
KERNEL_DIR = os.path.join(_ROOT, "runtimes", "cpp", "kernels")
