...
@group(0) @binding(1) var<storage, read> buf1: array<f32>;  // Y
...
fn main(
    ...
    let v29: f32 = buf1[u32(v23)];
    let v30: f32 = select(f32(0.0), v29, v24);
    let v31: f32 = v27 + v30;
    let v32: f32 = select(f32(0), v31, v24);
    if v24 { buf0[u32(v23)] = v32; }
}
