#!/usr/bin/env python3
"""Unit tests for all WGSL kernels in compiler/kernels/.

Dispatches each kernel on the GPU via DawnRunner and validates output
against numpy reference.

Usage:
    python -m pytest compiler/tests/test_kernels.py -v
    python -m pytest compiler/tests/test_kernels.py -k "test_softmax" -v
    python compiler/tests/test_kernels.py          # standalone
"""
