...
Usage:
    python -m pytest runtime/tests/test_ops.py -v
    python -m pytest runtime/tests/test_ops.py -k "test_add" -v
"""
...
# before importing onnxruntime to force the registry-based fallback.
import platform as _platform
if hasattr(_platform, '_wmi_query'):
    def _no_wmi(*a, **kw): raise OSError("WMI disabled")
